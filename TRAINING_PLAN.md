...
|-------|-----------|------------------|----------------|------|
| 1 | 168,000 | Flash Crowd | Single | Load Balancing |
| 2 | 420,000 | Sleepy Campus | 2-scenario | Energy Efficiency |
| 3 | 504,000 | Urban Canyon | 3-scenario | PHY Robustness |
| 4 | 756,000 | Mobility Storm | 4-scenario | Handover Success |
| 5 | 1,008,000 | Traffic Burst | 5-scenario | Overload Management |
| 6 | 1,008,000 | Ambulance | 6-scenario | Emergency Slicing |
| 7 | 1,260,000 | Spectrum Crunch | 7-scenario | Spectral Efficiency |
| 8 | 2,100,000 | Power Suite Mix | All equal | Full Generalization |

**Total Training Time**: ~7.2M timesteps Focused on mission-critical scenarios.
